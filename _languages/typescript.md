...
TypeScript is a superset of JavaScript that adds strong typing and compiles to
clean JavaScript output.

| Paradigms                                   | Typing | Memory Management | Execution                  |
| :------------------------------------------ | :----- | :---------------- | :------------------------- |
| Procedural<br>Object Oriented<br>Functional | Strong | Garbage Collected | Transpiled into JavaScript |
...
- Official repository: [microsoft/typescript](https://github.com/microsoft/typescript)
